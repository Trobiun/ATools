...
* Visual Studio 2019 (not the express edition)
* DirectX SDK
* Visual Studio Add-in 3.5.0 for Qt5 : https://download.qt.io/official_releases/vsaddin/3.5.0/
* Qt 5.13.1 for Windows 64 bits - VS 2019 : https://download.qt.io/archive/qt/5.13/5.13.1/qt-opensource-windows-x86-5.13.1.exe
